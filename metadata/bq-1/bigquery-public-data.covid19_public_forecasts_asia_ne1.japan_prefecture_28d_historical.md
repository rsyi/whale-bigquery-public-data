# `covid19_public_forecasts_asia_ne1.japan_prefecture_28d_historical`
`bq-1` | `bigquery-public-data`
This predicts the value for key metrics for COVID-19 impacts over a 28-day horizon in Japan at the prefecture level.
