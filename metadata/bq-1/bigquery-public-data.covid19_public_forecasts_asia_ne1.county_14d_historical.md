# `covid19_public_forecasts_asia_ne1.county_14d_historical`
`bq-1` | `bigquery-public-data`
This predicts the value for key metrics for COVID-19 impacts over a 14-day horizon at the US county level.
