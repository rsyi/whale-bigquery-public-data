# `sdoh_cdc_wonder_natality.county_natality_by_congenital_abnormalities`
...
* [STRING]    `Congenital_Abnormality_Checked_Desc`
 - Congenital Anomalies Checked
* [INTEGER]   `Congenital_Abnormality_Checked_YN`
 - Congenital Anomalies Checked Code
* [INTEGER]   `Births`
 - Number of Births
