# `geo_census_blockgroups.us_blockgroups_national`
...
* [STRING]    `state_name`
  - Full text name of the state that contains the block group
...
* [STRING]    `county_name`
  - Full text name of the country that contains the block group
* [STRING]    `tract_ce`
